...
internal static class AppInfo
{
    ...
    internal const string RepositoryUrl = "https://github.com/kurtian/DeskMux";
    internal const string ReleasesUrl = RepositoryUrl + "/releases";
    internal const string ReleasesApiUrl = "https://api.github.com/repos/kurtian/DeskMux/releases?per_page=20";
